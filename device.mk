...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/nfc/libnfc-brcm_beijingbus.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-brcm_beijingbus.conf \
    $(LOCAL_PATH)/configs/nfc/libnfc-brcm_productline.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-brcm_productline.conf \
    $(LOCAL_PATH)/configs/nfc/libnfc-brcm_shenzhentong.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-brcm_shenzhentong.conf \
    $(LOCAL_PATH)/configs/nfc/libnfc-brcm_yangchengtong.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-brcm_yangchengtong.conf \
...
# Seccomp policy
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/seccomp_policy/configstore@1.0.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/configstore@1.0.policy \
